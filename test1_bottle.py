...
def main_work():
    ...
    for speed in [1, 3]:
        ...
        for catching_dir in [1, 2, 3]:
            for pos in [1, 2, 3]:
                print(count)
                count += 1
                write_log.write_log(1, speed, 1, catching_dir, pos, time_diff)
    ...
    write_log.write_log(3, None, 1, None, None, time_diff)
...
def input_work(speed, catching_dir, pos):
    ...
    write_log.write_log(7, speed, 1, catching_dir, pos, time_diff)
    give(catching_dir, pos)
    y.reset_home()
    y.right.open_gripper()
    write_log.write_log(2, None, None, None, None, time_diff)
...
if __name__ == '__main__':
    ...
    if os.path.isfile('random_test1.txt'):
        pass
    else:
        f = open('random_test1.txt', 'w')
