...
def give(catching_dir, pos):
    if (catching_dir == 1): # top
        if (pos == 1):
            ...
            time.sleep(3)
            y.right.goto_pose(RigidTransform(translation = [0.53, 0, 0.07], rotation = right_top_slide_rotation))
            time.sleep(3)
            ...
            time.sleep(3)
            y.right.goto_pose(RigidTransform(translation = [0.58, 0, 0.3], rotation = right_top_slide_rotation))
            time.sleep(3)
            y.right.goto_pose(RigidTransform(translation = [0.53, 0, 0.3], rotation = right_top_rotation))
            y.right.goto_pose(RigidTransform(translation = [0.28, 0, 0.2], rotation = right_top_rotation))
            y.right.goto_pose(RigidTransform(translation = [0.28, 0, 0.01], rotation = right_top_rotation))
        ...
        if (pos == 1):
            ...
            time.sleep(3)
            y.right.goto_pose(RigidTransform(translation = [0.47, 0.04, 0.1], rotation = right_side_slide_rotation))
            time.sleep(3)
            ...
            time.sleep(3)
            y.right.goto_pose(RigidTransform(translation = [0.57, 0.04, 0.3], rotation = right_side_slide_rotation))
            time.sleep(3)
            y.right.goto_pose(RigidTransform(translation = [0.57, 0.04, 0.3], rotation = right_side_rotation))
            y.right.goto_pose(RigidTransform(translation = [0.28, 0.04 , 0.06], rotation = right_side_rotation))
            time.sleep(3)
        ...
        if (pos == 1):
            ...
            time.sleep(3)
            y.right.goto_pose(RigidTransform(translation = [0.6, 0, 0.1], rotation = right_front_slide_rotation))
            time.sleep(3)
            y.right.goto_pose(RigidTransform(translation = [0.6, 0, 0.1], rotation = right_front_rotation))
            y.right.goto_pose(RigidTransform(translation = [0.33, 0, 0.2], rotation = right_front_rotation))
            y.right.goto_pose(RigidTransform(translation = [0.33, 0, 0.058], rotation = right_front_rotation))
            ...
            time.sleep(3)
            y.right.goto_pose(RigidTransform(translation = [0.7, 0, 0.3], rotation = right_front_slide_rotation))
            time.sleep(3)
            y.right.goto_pose(RigidTransform(translation = [0.7, 0, 0.3], rotation = right_front_rotation))
            y.right.goto_pose(RigidTransform(translation = [0.33, 0, 0.2], rotation = right_front_rotation))
            y.right.goto_pose(RigidTransform(translation = [0.33, 0, 0.058], rotation = right_front_rotation))
    ...
    for speed in [1, 3]:
        ...
        for catching_dir in [1, 2, 3]:
            for pos in [1, 2, 3]:
                print(count)
                count += 1
                write_log.write_log(1, speed, 3, catching_dir, pos, time_diff)
...
def input_work(speed, catching_dir, pos):
    ...
    write_log.write_log(7, speed, 3, catching_dir, pos, time_diff)
    give(catching_dir, pos)
    y.reset_home()
    y.right.open_gripper()
    write_log.write_log(2, None, None, None, None, time_diff)
...
if __name__ == '__main__':
    ...
    right_top_slide_rotation = rpy_to_wxyz(90, 0, 210)
    right_side_slide_rotation = rpy_to_wxyz(0, 30, 90)
    right_front_slide_rotation = rpy_to_wxyz(90, 0, 120)
    ######################################################################
    ...
    if os.path.isfile('random_test3.txt'):
        pass
    else:
        f = open('random_test3.txt', 'w')
    ...
    while (True):
        zero_line = (search_string_in_file(write_log.file_name, 'end, bottle'))[0][0]
